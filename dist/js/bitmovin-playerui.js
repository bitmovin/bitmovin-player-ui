...
var Button = (function (_super) {
    ...
    Button.prototype.toDomElement = function () {
        var buttonElement = new dom_1.DOM2('button', {
            'type': 'button',
            'id': this.config.id,
            'class': this.getCssClasses()
        }).append(new dom_1.DOM2('span', {
            'class': 'label'
...
var Component = (function () {
    ...
    Component.prototype.toDomElement = function () {
        var element = new dom_1.DOM2(this.config.tag, {
            'id': this.config.id,
            'class': this.getCssClasses()
        });
        return element;
...
var Container = (function (_super) {
    ...
    Container.prototype.toDomElement = function () {
        var containerElement = new dom_1.DOM2(this.config.tag, {
            'id': this.config.id,
            'class': this.getCssClasses()
        });
        var innerContainer = new dom_1.DOM2(this.config.tag, {
...
var HugePlaybackToggleButton = (function (_super) {
    ...
    HugePlaybackToggleButton.prototype.toDomElement = function () {
        ...
        buttonElement.append(new dom_1.DOM2('div', {
            'class': 'image'
        }));
        return buttonElement;
    };
...
var Label = (function (_super) {
    ...
    Label.prototype.toDomElement = function () {
        var labelElement = new dom_1.DOM2('span', {
            'id': this.config.id,
            'class': this.getCssClasses()
        }).html(this.config.text);
        return labelElement;
...
var RecommendationItem = (function (_super) {
    ...
    RecommendationItem.prototype.toDomElement = function () {
        ...
        var itemElement = new dom_1.DOM2('a', {
            'id': this.config.id,
            'class': this.getCssClasses(),
            'href': config.url
        });
        var bgElement = new dom_1.DOM2('div', {
            'class': 'thumbnail'
        }).css({ "background-image": "url(" + config.thumbnail + ")" });
        itemElement.append(bgElement);
        var titleElement = new dom_1.DOM2('span', {
            'class': 'title'
        }).html(config.title);
        itemElement.append(titleElement);
        var timeElement = new dom_1.DOM2('span', {
            'class': 'duration'
...
var SeekBar = (function (_super) {
    ...
    SeekBar.prototype.toDomElement = function () {
        ...
        var seekBarContainer = new dom_1.DOM2('div', {
            'id': this.config.id,
            'class': this.getCssClasses()
        });
        var seekBar = new dom_1.DOM2('div', {
            'class': 'seekbar'
        });
        this.seekBar = seekBar;
        // Indicator that shows the buffer fill level
        var seekBarBufferLevel = new dom_1.DOM2('div', {
            'class': 'seekbar-bufferlevel'
        });
        this.seekBarBufferPosition = seekBarBufferLevel;
        // Indicator that shows the current playback position
        var seekBarPlaybackPosition = new dom_1.DOM2('div', {
            'class': 'seekbar-playbackposition'
        });
        this.seekBarPlaybackPosition = seekBarPlaybackPosition;
        // Indicator that show where a seek will go to
        var seekBarSeekPosition = new dom_1.DOM2('div', {
            'class': 'seekbar-seekposition'
        });
        this.seekBarSeekPosition = seekBarSeekPosition;
        // Indicator that shows the full seekbar
        var seekBarBackdrop = new dom_1.DOM2('div', {
        ...
        var mouseUpHandler = function (e) {
            ...
            new dom_1.DOM2(document).off('mousemove', mouseMoveHandler);
            new dom_1.DOM2(document).off('mouseup', mouseUpHandler);
            var targetPercentage = 100 * self.getMouseOffset(e);
            self.setSeeking(false);
            // Fire seeked event
        ...
        seekBar.on('mousedown', function (e) {
            ...
            new dom_1.DOM2(document).on('mousemove', mouseMoveHandler);
            new dom_1.DOM2(document).on('mouseup', mouseUpHandler);
        });
...
var SelectBox = (function (_super) {
    ...
    SelectBox.prototype.toDomElement = function () {
        var selectElement = new dom_1.DOM2('select', {
            'id': this.config.id,
            'class': this.getCssClasses()
        });
        ...
        selectElement.on('change', function () {
            ...
            var value = new dom_1.DOM2(this).val();
    ...
    SelectBox.prototype.updateDomItems = function (selectedValue) {
        ...
        for (var value in this.items) {
            ...
            var optionElement = new dom_1.DOM2('option', {
                'value': value
            }).html(label);
...
"use strict";
var DOM2 = (function () {
    function DOM2(something, attributes) {
     ...
     */
    DOM2.prototype.forEach = function (handler) {
        this.elements.forEach(function (element) {
            handler(element);
        });
    };
    DOM2.prototype.html = function (content) {
    ...
    DOM2.prototype.empty = function () {
        this.forEach(function (element) {
            element.innerHTML = '';
        });
        return this;
    };
    DOM2.prototype.val = function () {
    ...
    DOM2.prototype.attr = function (attribute, value) {
        this.forEach(function (element) {
            element.setAttribute(attribute, value);
        });
        return this;
    };
    DOM2.prototype.data = function (dataAttribute, value) {
    ...
    DOM2.prototype.append = function () {
        var childElements = [];
    ...
    DOM2.prototype.offset = function () {
        var element = this.elements[0];
    ...
    // TODO define handler signature
    // TODO support multiple eventNames (array or string)
    DOM2.prototype.off = function (eventName, eventHandler) {
        if (this.elements == null) {
    ...
    DOM2.prototype.addClass = function (className) {
        this.forEach(function (element) {
    ...
    DOM2.prototype.removeClass = function (className) {
        this.forEach(function (element) {
            if (element.classList) {
    ...
    DOM2.prototype.hasClass = function (className) {
        var element = this.elements[0];
        if (element.classList) {
    ...
    DOM2.prototype.css = function (ruleNameOrCollection, value) {
...
var UIManager = (function () {
    function UIManager(player, ui, config) {
        ...
        new dom_1.DOM2("#" + playerId).append(ui.getDomElement());
