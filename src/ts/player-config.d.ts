declare namespace bitmovin {
    ...
    namespace player {
        ...
        interface WidevineModularDRMConfig extends DRMConfig {
             ...
             * {@link https://w3c.github.io/encrypted-media/#mediakeysystemconfiguration-dictionary MediaKeySystemConfiguration}
             * for more details).
             * Please note that these settings need to be supported by the browser or playback will fail.
             */
