...
export class UIPreferencesManager {
  ...
  /**
   * Wires the manager to a player. The persisted `enabled` flag takes precedence; when the
   * user has not made an explicit choice yet, `enabledByDefault` (the integrator's
