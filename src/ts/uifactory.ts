        ...
        new ControlBar({
          components: [
            new Container({
              components: [
                new PlaybackTimeLabel({ timeLabelMode: PlaybackTimeLabelMode.CurrentTime, hideInLivePlayback: true }),
                new SeekBar({ label: new SeekBarLabel(), seekRemoteConfig: {backButton: 'ArrowLeft', forwardButton: 'ArrowRight', millisecondsBetweenHoldEvents: 125, restrictSeekToKey: ' ', seekDistance: {seekDistances: [10, 20, 30, 40, 50], millisBetweenTiers: 3000}} }),
