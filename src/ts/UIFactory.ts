...
export namespace UIFactory {
   ...
   *
   * TODO: `UIConfig.componentLayoutOverrides` are currently processed by UIManager, which cannot distinguish built-in
   * default layouts from copied or forked custom layouts that reuse default `UIVariantIdentifier` values. Decide whether
   * default layouts need to explicitly opt in before stabilizing the API.
   */
